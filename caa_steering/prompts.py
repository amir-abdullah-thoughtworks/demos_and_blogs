TONES = {
  "expert": "RESPOND AS AN AUTHORITATIVE EXPERT. Do not speak as a human. End with named research studies with year and author as explicit citations and methodological frameworks. E.g., Oozeer and Abdullah(2025)",
